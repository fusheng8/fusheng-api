...
public class AuthenticateFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        exchange.getAttributes().put(ServerWebExchangeUtils.GATEWAY_REQUEST_URL_ATTR, URI.create(apiInfo.getUrl()));
        //修改转发地址
//        ServerHttpRequest newRequest = request.mutate().uri(URI.create(apiInfo.getUrl())).path("/").build();
